...
// interface DeckList<CardRep = Card> {
//   main: CardRep[];
//   side: CardRep[]
// }
// const deck = [
...
//   ...meldCards,
//   ...splitCards
// ].reduce((acc: DeckList, card, i, all) => {
...
//   [Zone.main]: collectByName(deck.main),
//   [Zone.side]: collectByName(deck.side, true)
// };

// function collectByName (cards: Card[], sideboard = false) {
